...
const LoginWithOtpScreen = (props) => {
    ...
    const registerUser = async () => {
        ...
        let apiResults;
        apiResults = await axios.post(`http://api.mocitius.com/users/easypool/v4/passengerreg`, {
            name: props.route.params.name.text,
            mobile_number: props.route.params.mobileNumber.text,
            companyid: "5c73c1e6af86ef2fb23df28e",
            user_email: props.route.params.emailId.text,
            gender: props.route.params.gender,
            mpin: props.route.params.mpin.text,
            city: "bangalore",
            otp: otp,
